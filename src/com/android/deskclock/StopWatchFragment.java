...
public class StopWatchFragment extends AbstractTimerFragment implements View.OnClickListener {
    ...
    public boolean onNotifyOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_item_stopwatch_hide_last_lap:
            boolean status = pref.getBoolean(StopWatchPreferences.PREF_HIDE_LAST_LAP_PANEL, false);
    ...
    public void onResume() {
        ...
        initializeTimers();
        initializePanelInfo(!isTimerCreated());
    }
    ...
    protected void onUiChanged() {
        ...
        if (!running) {
            if (!valid) {
                ...
                this.mMainButton.setContentDescription(getString(R.string.stopwatch_actions_start_cd));
            } else {
                // Resume. If not initialized or not running
                this.mMainButton.setText(getString(R.string.stopwatch_actions_resume));
                this.mMainButton.setContentDescription(getString(R.string.stopwatch_actions_resume_cd));
            }
        } else {
        ...
        if ((this.mSectors != 0) && this.mCurrentSector < this.mSectors) {
            ...
            this.mPartialButton.setContentDescription(getString(R.string.stopwatch_actions_sector_cd));
        } else {
            this.mPartialButton.setText(getString(R.string.stopwatch_actions_lap));
            this.mPartialButton.setContentDescription(getString(R.string.stopwatch_actions_lap_cd));
        }
    }
    ...
    /**
     * Method that update the timers
     *
     * @throws RemoteException If can't access to the timer service
     */
    @Override
    protected void updateTimers() throws RemoteException {
