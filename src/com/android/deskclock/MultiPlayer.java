...
public class MultiPlayer implements MediaPlayer.OnCompletionListener {
    ...
    private Uri getNextUri() {
        ...
        if (mCursor == null) {
            LogUtils.e("MultiPlayer: mCursor = null");
            return null;
        }
