...
public class Utils {
    ...
    public static boolean dimClockView(boolean dim, View clockView) {
        ...
        paint.setColorFilter(new PorterDuffColorFilter( Color.parseColor(colorFilter), PorterDuff.Mode.MULTIPLY));
    ...
    public static String getClockColorFilter(boolean dim, View clockView) {
        ...
        if (nightModeDND) {
            NotificationManager mNotificationManager = (NotificationManager) clockView.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        final int brightnessPercentage = DataModel.getDataModel().getScreensaverNightModeBrightness();
    ...
    public static void setTimeFormat(TextClock clock, boolean includeSeconds) {
        if (clock != null) {
            ...
            clock.setFormat12Hour(get12ModeFormat(0.4f /* amPmRatio */, includeSeconds, true, true));
    ...
    public static void setScreensaverTimeFormat(TextClock clock, boolean includeSeconds) {
        if (clock != null) {
            ...
            // Get the best format for 12 hours mode according to the locale
            CharSequence pattern = get12ModeFormat(0.4f /* amPmRatio */, includeSeconds, boldText, showAmPm);
     ...
     * @return format string for 12 hours mode time, not including seconds
     */
    public static CharSequence get12ModeFormat(float amPmRatio, boolean includeSeconds, boolean amPmBolded, boolean amPmDisplayed) {
