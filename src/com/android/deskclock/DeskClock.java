...
/**
 * DeskClock clock view for desk docks (contains the StopWatch, DeskClock and CountDown
 * fragments).
 */
public class DeskClock extends FragmentActivity {
     ...
     * @hide
     */
    public static final String PREFERENCES_FILENAME = "com.android.deskclock"; //$NON-NLS-1$

    private static final String KEY_CURRENT_PAGE = "current_page"; //$NON-NLS-1$
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter.add(StopWatchFragment.class, new Bundle());
        adapter.add(DeskClockFragment.class, new Bundle());
        adapter.add(CountDownFragment.class, new Bundle());
        ...
        this.mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(
                ...
                if (!DeskClock.this.mLockTransparency) {
                    int to = (position != DeskClockFragments.DESKCLOCK.ordinal() ? 1 : 0);
                    int transparency = (int)((Math.abs(to - positionOffset)) * 255);
    ...
    private void setDefaultPage() {
        ...
        if (timerType != null
            ...
            if (this.mRestorePage != -1) {
                this.mViewPager.setCurrentItem(this.mRestorePage);
            } else {
    ...
    /**
     * Method that returns the preferences
     * @return
     */
    ...
    /**
     * Method that saves the preferences
     */
    private void saveData() {
        // Save all countdown state to preference
        SharedPreferences.Editor editor = getPreferences().edit();
        editor.putInt(KEY_CURRENT_PAGE, this.mViewPager.getCurrentItem());
        editor.commit();
    }

    /**
     * Method that read the preferences
     */
    private void readData() {
        // Read all countdown state to preference
        SharedPreferences sp = getPreferences();
        this.mRestorePage = sp.getInt(KEY_CURRENT_PAGE, -1);
    }
}
