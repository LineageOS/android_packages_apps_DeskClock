            ...
            final DialogInterface.OnClickListener clickListener = new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        try {
                            ContentResolver cr =
                                  CountDownFragment.this.getFragmentActivity().getContentResolver();
                    ...
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        try {
                            ContentResolver cr =
                              ...
                              int count = cr.delete(CountDownTimer.Columns.CONTENT_URI, where, whereArgs);
                              if (count == 0) {
                                  showExceptionDialog(null, null, R.string.msg_operation_fails);
                              }
                        } catch (Exception e) {
    ...
    protected void onUiChanged() {
        ...
        if (!running) {
            if (!valid || this.mClockTime == 0 || this.mMainClock.isInDefaultValue()) {
                ...
                this.mMainButton.setContentDescription(getString(R.string.countdown_actions_start_cd));
            } else {
                // Resume. If not initialized or not running
                this.mMainButton.setText(getString(R.string.countdown_actions_resume));
                this.mMainButton.setContentDescription(getString(R.string.countdown_actions_resume_cd));
            }
        } else {
