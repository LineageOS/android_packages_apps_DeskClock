                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            mSelectedAlarm.alert = MultiPlayer.RANDOM_URI;
        ...
        private String getRingToneTitle(Uri uri) {
            ...
            if (title == null) {
                if (uri.toString().equals("random")) {
                    title = getResources().getString(R.string.random_song);
                } else {
                    ...
                    if (rawUri.startsWith(Audio.Media.EXTERNAL_CONTENT_URI.toString())
                        ...
                        columnName = Audio.Playlists.NAME;
                    }
                    if (columnName != null) {
                        ...
                        if (c.moveToFirst()) {
                            title = c.getString(c.getColumnIndex(columnName));
                        }
                    }
                }
                if (title != null) {
