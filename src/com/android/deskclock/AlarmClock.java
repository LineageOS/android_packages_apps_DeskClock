...
public class AlarmClock extends Activity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    private void launchRingTonePicker(final Alarm alarm) {
        ...
        int option;
        builder.setTitle("Choose ringtone type")
        .setItems(new String[] {"Ringtone", "Playlist", "Random"}, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                ...
                case 2:
                    ...
                    RingtoneManager.setActualDefaultRingtoneUri(AlarmClock.this, RingtoneManager.TYPE_ALARM, mSelectedAlarm.alert);
