...
public class TimerClockService extends Service {
    ...
    private final ITimerClockService.Stub mBinder = new ITimerClockService.Stub() {
        ...
        public long createTimer(int type) throws RemoteException {
            synchronized (TimerClockService.this.mServiceSync) {
                ...
                timer.mId = System.nanoTime(); // This should be sufficient to create unique identifiers
                ...
                case COUNTDOWN:
                    ...
                    if (showNotification) {
                        createCountDownNotification(
                                    timer,
                                    getString(R.string.service_countdown_notification_title_progress),
                                    getString(R.string.service_countdown_notification_summary),
                                    false);
                    }
                    break;
        ...
        public void stopTimer(long timerId) throws RemoteException {
            ...
            synchronized (timer.mSync) {
                ...
                case STOPWATCH:
                    ...
                    timer.mElapsed = internalQueryTime(timerId, now);
                    break;
                ...
                case COUNTDOWN:
                    ...
                    timer.mCountDownTime = internalQueryTime(timerId, now);
     ...
     * @param autocancel The system auto cancel the notification
     */
    private synchronized void createCountDownNotification(
            Timer timer, String title, String msg, boolean endCountDown) {
        ...
        builder.setLargeIcon(
                BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher_timer));
    ...
    private void showFinalCountDownNotification(Timer timer) {
        ...
        if (showNotification) {
            createCountDownNotification(
                    timer,
                    getString(R.string.service_countdown_notification_title_end),
                    getString(R.string.service_countdown_notification_summary),
                    true);
        } else {
    ...
    private void showFinalCountDownView(Timer timer, boolean onCall) {
        ...
        if (!onCall && openClockView) {
            ...
            Toast.makeText(
                    TimerClockService.this,
                    R.string.service_countdown_notification_title_end,
