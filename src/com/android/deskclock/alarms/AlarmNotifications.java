...
public final class AlarmNotifications {
    ...
    /**
     *  Old notification channels - we have to keep the IDs so we can remove the channels
     */
    public static final String ALARM_LOW_PRIORITY_NOTIFICATION_CHANNEL_ID =
            "alarmLowPriorityNotification";
    public static final String ALARM_HIGH_PRIORITY_NOTIFICATION_CHANNEL_ID =
            "alarmHighPriorityNotification";

    /**
     * Notification channel containing all upcoming notifications.
     */
     ...
     */
    public static final String ALARM_NOTIFICATION_CHANNEL_ID = "alarmNotification";
    ...
    static synchronized void showLowPriorityNotification(Context context,
        ...
        createUpcomingAlarmChannel(context, nm);
    ...
    private static void updateMissedAlarmGroupNotification(Context context,
        ...
        final NotificationManagerCompat nm = NotificationManagerCompat.from(context);
        NotificationUtils.createChannelIfRequired(nm, ALARM_NOTIFICATION_CHANNEL_ID,
        ...
        if (summary == null
            ...
            NotificationUtils.createChannelIfRequired(nm, ALARM_MISSED_NOTIFICATION_CHANNEL_ID,
    ...
    static synchronized void showSnoozeNotification(Context context,
        ...
        NotificationManagerCompat nm = NotificationManagerCompat.from(context);
        NotificationUtils.createChannelIfRequired(nm, ALARM_SNOOZE_NOTIFICATION_CHANNEL_ID,
    ...
    private static void createUpcomingAlarmChannel(Context context, NotificationManagerCompat nm) {
        ...
        NotificationChannel channel = new NotificationChannel(
                ALARM_UPCOMING_NOTIFICATION_CHANNEL_ID,
                context.getString(R.string.alarm_upcoming_notification),
