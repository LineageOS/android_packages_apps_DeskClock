...
import static com.android.deskclock.NotificationUtils.ALARM_NOTIFICATION_CHANNEL_ID;
...
public final class AlarmNotifications {
    ...
    private static void updateMissedAlarmGroupNotification(Context context,
        ...
        final NotificationManagerCompat nm = NotificationManagerCompat.from(context);
        NotificationUtils.createChannel(context, ALARM_NOTIFICATION_CHANNEL_ID);
