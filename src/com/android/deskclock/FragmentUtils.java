...
public final class FragmentUtils {
    ...
    private DeskClockFragment getDeskClockFragment(UiDataModel.Tab tab) {
        ...
        fragment.setFabContainer(mDeskClock);
        mFragmentManager.beginTransaction().add(R.id.fragment_container, fragment, tab.name()).commit();
        mFragmentCache.put(tab, fragment);
        return fragment;
    }
