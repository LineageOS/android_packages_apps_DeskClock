...
public final class SettingsActivity extends CollapsingToolbarBaseActivity {
    ...
    public static class PrefsFragment extends PreferenceFragmentCompat implements
        ...
        public boolean onPreferenceClick(@NonNull Preference pref) {
            ...
            switch (pref.getKey()) {
                case KEY_SS_DAYDREAM_SETTINGS:
                    final Intent dialoSSMainSettingsIntent = new Intent(
                            Settings.ACTION_DREAM_SETTINGS);
                    dialoSSMainSettingsIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(dialoSSMainSettingsIntent);
                    return true;
                case KEY_SS_PREVIEW:
        ...
        private void refresh() {
            ...
            final Preference screensaverSetting = findPreference(KEY_SS_SETTINGS);
            screensaverSetting.setOnPreferenceClickListener(this);
