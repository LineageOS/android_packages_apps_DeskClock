...
public final class SettingsActivity extends BaseActivity {
    ...
    public static class PrefsFragment extends PreferenceFragmentCompat implements
        ...
        private void updateActionSummary(SimpleMenuPreference simpleMenuPref, String action,
                int summaryResId) {
            int i = simpleMenuPref.findIndexOfValue(action);
            simpleMenuPref.setSummary(getString(summaryResId,
