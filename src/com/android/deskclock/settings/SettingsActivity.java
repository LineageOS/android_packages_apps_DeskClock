        ...
        public boolean onPreferenceChange(Preference pref, Object newValue) {
            switch (pref.getKey()) {
                ...
                case KEY_FLIP_ACTION:
                    ...
                    updateActionSummary(flipActionPref, (String) newValue, R.string.flip_action_summary);
                    break;
                case KEY_SHAKE_ACTION:
                    final ListPreference shakeActionPref = (ListPreference) pref;
                    updateActionSummary(shakeActionPref, (String) newValue, R.string.shake_action_summary);
                    break;
            }
