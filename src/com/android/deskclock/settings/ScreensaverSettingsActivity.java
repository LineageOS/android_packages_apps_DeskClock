...
public final class ScreensaverSettingsActivity extends CollapsingToolbarBaseActivity {
    ...
    public static final String KEY_NIGHT_MODE_BRIGHTNESS = "screensaver_clock_night_mode_brightness";
    ...
    public static class PrefsFragment extends PreferenceFragmentCompat
        ...
        public boolean onPreferenceChange(Preference pref, Object newValue) {
            ...
            if (KEY_CLOCK_COLOR.equals(pref.getKey()) || KEY_NIGHT_MODE_COLOR.equals(pref.getKey())) {
                final ListPreference clockColorPref = (ListPreference) pref;
                final int index = clockColorPref.findIndexOfValue((String) newValue);
                clockColorPref.setSummary(clockColorPref.getEntries()[index]);
            }
            if (KEY_NIGHT_MODE_BRIGHTNESS.equals(pref.getKey())) {
        ...
        private void refresh() {
            ...
            if (nightModeDNDPref != null) {
                nightModeDNDPref.setChecked(DataModel.getDataModel().getScreensaverNightModeDNDOn());
            }
