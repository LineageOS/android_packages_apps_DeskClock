...
public final class ScreensaverSettingsActivity extends CollapsingToolbarBaseActivity {
    ...
    public static class PrefsFragment extends PreferenceFragmentCompat
        ...
        private String progress_template = "%s%%";

        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);

            this.progress_template = getResources().getString( R.string.clock_brightness_percentage );
        ...
        public boolean onPreferenceChange(Preference pref, Object newValue) {
            switch (pref.getKey()) {
                ...
                case KEY_NIGHT_MODE_BRIGHTNESS:
                    ...
                    final String progress = String.format( this.progress_template,
