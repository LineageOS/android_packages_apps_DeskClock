...
public class CityAndTimeZoneLocator {
    ...
    private final AsyncTask<Void, Void, Void> resolveTask = new AsyncTask<Void, Void, Void>() {

        private boolean hasNetworkAvailable = false;
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                Log.e(TAG, "Fail to read data", ex);
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            if (mCity == null || (hasNetworkAvailable && mTZ == null)) {
                if (mCallback != null) {
    ...
    public CityAndTimeZoneLocator(
            Context context, Location location, ConnectivityManager connMgr,
            OnCityAndTimeZoneLocatedCallback callback) {
        mContext = context;
        mLocation = location;
        mConnMgr = connMgr;
        mCallback = callback;
    ...
    private String resolveCity() {
        try {
            ...
            Log.e(TAG, "Fail to retrieve city", ex);
        }
        return null;
    }
    ...
    private TZ resolveTimeZone() {
        ...
        try {
            ...
            final URI uri = new URI(
                                    String.format(TIMEZONE_SERVICE_URI,
            ...
            Log.e(TAG, "Fail to retrieve timezone", ex);
    ...
    private TZ parseTimeZoneResponse(BufferedReader br) {
        try {
            ...
            Log.e(TAG, "Fail to parse timezone response", ex);
        }
        return null;
    }
}
