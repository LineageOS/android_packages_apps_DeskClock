...
public class StopwatchNotificationBuilder {
    ...
    /*
     * Old channel id, keep it to be able to remove the channel
     */
     ...
     */
    public static final String STOPWATCH_NOTIF_CHANNEL_ID = "StopwatchNotif";

    public void buildChannel(Context context, NotificationManagerCompat notificationManager) {
        NotificationUtils.createChannelIfRequired(notificationManager,
                STOPWATCH_NOTIF_CHANNEL_ID,
    ...
    public Notification build(Context context, NotificationModel nm, Stopwatch stopwatch) {
        ...
        final Builder notification = new NotificationCompat.Builder(
                context, STOPWATCH_NOTIF_CHANNEL_ID)
                        .setLocalOnly(true)
                        .setOngoing(running)
