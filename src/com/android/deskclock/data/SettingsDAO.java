...
final class SettingsDAO {
    ...
    /**
     * @return a value indicating what color the digital clock is in the screensaver
     */
    static String getClockColor(Context context, SharedPreferences prefs) {
     ...
     * @return a value indicating what color the digital clock is in the screensaver in Night Mode
     */
    static Boolean getClockNightModeDnD(Context context, SharedPreferences prefs) {
        return prefs.getBoolean(ScreensaverSettingsActivity.KEY_NIGHT_MODE_DND,
                context.getResources().getBoolean(R.bool.default_clock_night_mode));
    }
    ...
    private static String getClockColor(Context context, SharedPreferences prefs, String key) {
        ...
        // Use hardcoded locale to perform toUpperCase, because in some languages toUpperCase adds
        // accent to character, which breaks the enum conversion.
        return clockColor.valueOf(clockColor.toUpperCase(Locale.US));
    }
