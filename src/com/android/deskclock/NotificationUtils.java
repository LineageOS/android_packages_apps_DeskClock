...
public class NotificationUtils {
     ...
     */
    public static final String STOPWATCH_NOTIFICATION_CHANNEL_ID = "StopwatchNotif";
    ...
    static {
        CHANNEL_PROPS.put(ALARM_UPCOMING_NOTIFICATION_CHANNEL_ID, new int[]{
                R.string.alarm_upcoming_notification, IMPORTANCE_LOW });
        CHANNEL_PROPS.put(ALARM_NOTIFICATION_CHANNEL_ID, new int[]{
                R.string.alarm_notification, IMPORTANCE_HIGH });
        CHANNEL_PROPS.put(ALARM_MISSED_NOTIFICATION_CHANNEL_ID, new int[]{
                R.string.alarm_missed_notification, IMPORTANCE_HIGH });
        CHANNEL_PROPS.put(ALARM_SNOOZE_NOTIFICATION_CHANNEL_ID, new int[]{
                R.string.alarm_snooze_notification, IMPORTANCE_HIGH });
        CHANNEL_PROPS.put(STOPWATCH_NOTIFICATION_CHANNEL_ID, new int[]{
                R.string.stopwatch_notification, IMPORTANCE_LOW });
        CHANNEL_PROPS.put(TIMER_MODEL_NOTIFICATION_CHANNEL_ID, new int[]{
            R.string.timer_model_notification, IMPORTANCE_HIGH });
    }
