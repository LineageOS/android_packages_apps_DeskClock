...
/**
 * A {@link PageAdapter} class for swiping between DeskClock, StopWatch and CountDown
 * fragments.<br/>
 * <br/>
 * This page adapter implements the next logical views:<br/>
 * <br/>
 * <pre>StopWatch :: DeskClock :: CountDown</pre>
 * <br/>
...
public class DeskClockPagerAdapter extends FragmentPagerAdapter {
    ...
    private final Map<Integer, WeakReference<Fragment>> mWeakFragmentMap =
    ...
    public Fragment getFragment(int position) {
        WeakReference<Fragment> weakFragment = this.mWeakFragmentMap.get(position);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        this.mWeakFragmentMap.put(position, new WeakReference<Fragment>(fragment));
        return fragment;
    }
